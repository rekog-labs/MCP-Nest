 ...
 * McpCapabilityBuilder instances that may be created by the DI container.
 */
 ...
 *   constructor(
 *     private readonly capabilityBuilder: McpCapabilityBuilder,
 ...
 */
@Injectable()
export class McpCapabilityBuilder {
